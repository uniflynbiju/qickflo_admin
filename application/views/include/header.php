...
<head>
    ...
    <title>Quickflo</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?php echo base_url(); ?>assets/img/favicon/quickflo_logo_top.png" />
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <div class="app-brand-text demo menu-text fw-bolder ms-0">
            <img src="<?php echo base_url(); ?>assets/img/favicon/quikFlo-green.png" alt="Logo" 
            style="width:200px;">
          </div>
            </a>
