...
<body>
                        ...
                        <div class="card" style="margin-top: 39px; margin-left: 25px; margin-right: 25px;">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <a href="<?php echo base_url() . 'index.php/welcome/product_categories_add/' ?>"
                                        style="color:#0d6efd;">
                                        <button style="float: inline-end;" class=" button-31" role="button">ADD PRODUCT
                                            CATEGORY</button>
                                    </a>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img src="<?php echo $product_category['Image']; ?>" alt="Image"
                                                ...
                                                <td>
                                                    ...
                                                    if (!empty($product_category['CategoryId'])) {
                                                        $category_id = $product_category['CategoryId'];
                                                ...
                                                <td>
                                                    <?php
                                                    // Check if $value['category_id'] is not empty
                                                    if (!empty($product_category['SubCategoryId'])) {
                                                        $category_id = $product_category['SubCategoryId'];
                                                ...
                                                <td>
                                                    <?php
                                                    $status = isset($product_category['Status']) ? $product_category['Status'] : '-';
                                                    $documentId = isset($product_category['_id']) ? $product_category['_id'] : '-';
                                                    if ($status == 0) {
                                                ...
                                                <td class="action">
                                                    <div class="button-container">
                                                        <a href="<?php echo base_url() . 'index.php/welcome/product_categories_edit/' . $product_category['_id'] ?>"
                                                            title="Edit" style="color:#0d6efd;">
                                                            <button type="button" class="btn btn-primary">Edit</button>
                                                        </a>
                                                        <a onclick="return confirm('Are you sure you want to delete?');"
                                                            href="<?php echo base_url() . 'index.php/welcome/delete_product_categories/' . $product_category['_id'] ?>"
                                                            title="Delete" style="color:#0d6efd;">
    ...
    function updateStatus(button) {
        ...
        $.ajax({
            url: "<?php echo base_url('index.php/Welcome/product_category_status'); ?>", // Assuming the base_url() function is properly configured
            method: 'POST',
            data: {
